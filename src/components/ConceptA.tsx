  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-yellow-300 via-orange-300 to-red-400 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center space-y-8 p-8 relative z-10">
        ...
        <div className="mt-16 inline-block px-6 py-3 bg-gradient-to-r from-purple-500 via-blue-500 to-cyan-500 text-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] font-bold text-lg transform -rotate-1 motion-safe:animate-pulse">
